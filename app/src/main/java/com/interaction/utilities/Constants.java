package com.interaction.utilities;
    ...
    public static HashMap<String, String> getRemoteMsgHeaders() {
        if (remoteMsgHeaders == null) {
            ...
            remoteMsgHeaders.put(REMOTE_MSG_AUTHORIZATION,
                    "key=AAAA6dRci38:APA91bEPt-oM9iyzZAAubapmaMdMI_qvA0p7-HVDK28N1h9kKpo7FqCyxVbFZBSdmYv-gXnlMLPupIUmduseZgmD6E9Ujev4fftp4PZCEEAlAIF2dIoQjo28BR2KarZhhWNiac8fk4bg"
            );
